...
type ParametersExceptFirst<Func> = Func extends (
	arg0: any,
	...rest: infer R
) => any
	? R
...
type TypedParsersSchema<Schema extends z.ZodType> = Omit<
	Schema,
	ParseMethods
> & {
	[Method in ParseMethods]: (
		...args: Params<Schema, Method>
	) => ReturnType<Schema[Method]>
}
